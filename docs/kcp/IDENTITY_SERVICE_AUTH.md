...
CHALLENGE_VERIFY_PATH = /v1/auth/complete
REGISTRATION_START_PATH = /v1/registration/challenges
REGISTER_PATH = /v1/registration/complete
RECOVERY_START_PATH = /v1/account-recovery/challenges
